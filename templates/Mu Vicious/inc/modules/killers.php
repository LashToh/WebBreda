...
try {
    ...
    if(!mconfig('rankings_enable_pk') || !mconfig('active')) {
    ...
    echo '<h4 class="text-center page-title mb-4">
            <i class="fas fa-skull-crossbones me-2" style="color: #e8a34f;"></i> Top Kills
          </h4>';
    ...
    foreach($ranking_data as $rdata) {
        ...
        $kills     = isset($rdata[3]) ? number_format($rdata[3]) : 0;
        ...
        echo '<td class="fw-bold">'.$kills.'</td>';
        echo '</tr>';
    ...
    echo 'Error al cargar ranking de Killers.';
    echo '</div>';
    echo '</div>';
